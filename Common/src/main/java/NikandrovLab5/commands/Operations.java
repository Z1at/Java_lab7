...
public class Operations {
    ...
    public int run(String[] clientMessage, Collection collection, ServerMessage answer, Operations operations, String login) throws SQLException {
...
//            answer.plusMessage(save.save(environmentVariable, collection));
    ...
    private boolean check(String key, Collection collection, String login){
        boolean flag = false;
